...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        while (true) {
            ...
            switch (sc.nextInt()) {
                ...
                case 10 -> tonenBierenPerSoort(soortRepository);
            }
        }
    ...
    private static void tonenBierenPerSoort(SoortRepository soortRepository) {
        String soorten;

        System.out.println("Give me the soort of biere");
        soorten = sc.next();
        try {
            soortRepository.bierenVanSorten(soorten).forEach(System.out::println);
    ...
    private static void tonenMenu() {
        ...
        sb
                ...
                .append("\n").append(10).append(" tonenBierenPerSoort");
